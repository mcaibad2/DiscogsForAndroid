...
public class LabelReleasesActivity extends ActionBarListActivity
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
		...
		setContentView(R.layout.layout_label_releases);
		init();
    }
	...
	private void init() 
	{
		...
		setTitle(extras.getString("title") + " Discography");
		...
		Thread thread = new Thread(new Runnable() 
		{
			...
			public void run() 
			{
				releases = engine.getLabelReleases(resourceUrl, 1);
	...
	protected void onListItemClick(ListView listView, View view, int position, long id) 
	{
		...
		intent.putExtra("title", release.getArtist() + " - " + release.getTitle());
		startActivity(intent);
	}
